/* COPIED, DO NOT EDIT — run `node _build/booking-data.mjs`.
   Source: src/lib/pricing.js (live site, 2026-09-25).
   NEW DESIGN ONLY (_build/deviations.mjs): Anfahrtspauschale 65 → 70 */
...
import { serviceCategories, tierPackages } from './services.js';

/** Flat Anfahrtspauschale for the mobile service. Not multiplied by the size factor. */
export const MOBILE_SURCHARGE = 70;
